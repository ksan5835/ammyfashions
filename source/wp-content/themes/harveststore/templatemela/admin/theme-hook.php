...
<div class="main-block">
  <div class="icon-templatemela"><img src="<?php echo esc_attr(get_option( 'siteurl' )).'/wp-content/themes/'.get_option( 'template' ).'/templatemela/logo.png'; ?>" /></div>
  ...
  <div id="General">
	...
	if(!isset( $_REQUEST['reset1'] )) {$_REQUEST['reset1']=''; }
      ...
      <div class="main_title">
        <h1>
          <?php esc_html_e('Hook Manager','harvest');?>
        </h1>
      </div>
      <?php
       $i= 0;
