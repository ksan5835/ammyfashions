...
foreach ($fonts_array as $key => $val) {
	if($val!='' && $val!='please-select' && $val!='Other+Fonts' && $val!='Open+Sans'){ ?>
		<link href='//fonts.googleapis.com/css?family=<?php echo esc_attr($val); ?>' rel='stylesheet' type='text/css' />
	<?php }
}
...
<style type="text/css">
	...
	h1 {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_h1font_other'))); ?>', Arial, Helvetica, sans-serif;		
	}	
	<?php } } elseif(get_option('tmoption_h1font') != "" && get_option('tmoption_h1font') != "please-select"){ ?>
	h1 {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_h1font'))); ?>', Arial, Helvetica, sans-serif;
	}	
	<?php } ?>
	<?php if (get_option('tmoption_h1color') != ""){ ?>
	h1 {	
		color:#<?php echo esc_attr(get_option('tmoption_h1color')); ?>;	
	}	
	<?php } ?>
	...
	h2 {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_h2font_other'))); ?>', Arial, Helvetica, sans-serif;	
	}	
	<?php } } elseif(get_option('tmoption_h2font') != "" && get_option('tmoption_h2font') != "please-select"){ ?>
	h2 {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_h2font'))); ?>', Arial, Helvetica, sans-serif;
	}	
	<?php } ?>
	<?php if(get_option('tmoption_h2color') != ""){ ?>
	h2 {	
		color:#<?php echo esc_attr(get_option('tmoption_h2color')); ?>;	
	}	
	<?php } ?>
	<?php 
	...
	h3 {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_h3font_other'))); ?>', Arial, Helvetica, sans-serif;
	}	
	<?php } } elseif(get_option('tmoption_h3font') != "" && get_option('tmoption_h3font') != "please-select"){ ?>
	h3 {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_h3font'))); ?>', Arial, Helvetica, sans-serif;
	}	
	<?php } ?>
	<?php if (get_option('tmoption_h3color') != ""){ ?>
	h3 { color:#<?php echo esc_attr(get_option('tmoption_h3color')); ?>;}
	<?php } ?>
	...
	h4 {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_h4font_other'))); ?>', Arial, Helvetica, sans-serif;
	}	
	<?php } } elseif(get_option('tmoption_h4font') != "" && get_option('tmoption_h4font') != "please-select"){ ?>
	h4 {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_h4font'))); ?>', Arial, Helvetica, sans-serif;
	}	
	<?php } ?>	
	<?php if(get_option('tmoption_h4color') != ""){ ?>
	h4 {	
		color:#<?php echo esc_attr(get_option('tmoption_h4color')); ?>;	
	}	
	<?php } ?>
	...
	h5 {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_h5font_other'))); ?>', Arial, Helvetica, sans-serif;
	}	
	<?php } } elseif(get_option('tmoption_h5font') != "" && get_option('tmoption_h5font') != "please-select"){ ?>
	h5 {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_h5font'))); ?>', Arial, Helvetica, sans-serif;
	}	
	<?php } ?>
	<?php if(get_option('tmoption_h5color') != ""){ ?>
	h5 {	
		color:#<?php echo esc_attr(get_option('tmoption_h5color')); ?>;	
	}	
	<?php } ?>
	...
	h6 {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_h6font_other'))); ?>', Arial, Helvetica, sans-serif;
	}	
	<?php } } elseif(get_option('tmoption_h6font') != "" && get_option('tmoption_h6font') != "please-select"){ ?>
	h6 {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_h6font'))); ?>', Arial, Helvetica, sans-serif;
	}	
	<?php }  ?>	
	<?php 
	if(get_option('tmoption_h6color') != ""){ ?>
	h6 {	
		color:#<?php echo esc_attr(get_option('tmoption_h6color')); ?>;	
	}	
	<?php } ?>
	...
	a {
		color:#<?php echo esc_attr(get_option('tmoption_link_color')); ?>;
	}
	a:hover {
		color:#<?php echo esc_attr(get_option('tmoption_hoverlink_color')); ?>;
	}
	.footer a, .site-footer a, .site-footer{
		color:#<?php echo esc_attr(get_option('tmoption_footerlink_color')); ?>; 
	}
	.footer a:hover, .footer .footer-links li a:hover, .site-footer a:hover{
		color:#<?php echo esc_attr(get_option('tmoption_footerhoverlink_color')); ?>;		 
	}
	<?php 
	if( (get_option('tmoption_h3font') == "Other+Fonts") || get_option('tmoption_h3font') == "please-select"){  
	if	(get_option('tmoption_h3font_other') != ""){ ?>
	...
	.site-footer {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_footerfont_other'))); ?>', Arial, Helvetica, sans-serif;
	}	
	<?php } } elseif(get_option('tmoption_footerfont') != "" && get_option('tmoption_footerfont') != "please-select"){ ?>
	.site-footer {	
		font-family:'<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_footerfont'))); ?>', Arial, Helvetica, sans-serif;	
	}	
	<?php } ?>	
	.site-footer {
		background-color:#<?php echo esc_attr(get_option('tmoption_footerbkg_color')) ; ?> ;
	}
	.navbar, .navbar-mobile {
		background-color:#<?php echo esc_attr(get_option('tmoption_navigationbkg_color')) ; ?> ;
	}
	body {
		background-color:#<?php echo esc_attr(get_option('tmoption_bkg_color')) ; ?> ;
		<?php if(get_option('tmoption_background_upload')==''){ ?>
		background-image: url("<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/colorpicker/pattern/<?php echo esc_attr(get_option('tmoption_texture')); ?>");
		background-position:<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_back_position'))); ?> ;
		background-repeat:<?php echo esc_attr(get_option('tmoption_back_repeat')); ?>;
		background-attachment:<?php echo esc_attr(get_option('tmoption_back_attachment')); ?>;
		<?php } else { ?>
		background-image: url("<?php echo esc_attr(get_option('tmoption_background_upload')); ?>");
		background-position:<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_back_position'))); ?>;
		background-repeat:<?php echo get_option('tmoption_back_repeat'); ?>;
		background-attachment:<?php echo esc_attr(get_option('tmoption_back_attachment')); ?>;
		<?php } ?>			
		color:#<?php echo esc_attr(get_option('tmoption_bodyfont_color')); ?>;
	} 
	
	.topbar-outer{background:<?php echo harvest_hex_to_rgba(esc_attr(get_option('tmoption_topbar_bkg_color')),esc_attr(get_option('tmoption_topbar_bkg_opacity'))); ?>}
	.topbar-main,.contact-phone,.cal-us{ color:#<?php echo esc_attr(get_option('tmoption_topbar_text_color')); ?>; }
	.topbar-main a,.header-menu-links li a,.header_logout a{ color:#<?php echo esc_attr(get_option('tmoption_topbar_link_color')); ?>; }
	.topbar-main a:hover,.header-menu-links li a:hover,.header_logout a:hover{ color:#<?php echo esc_attr(get_option('tmoption_topbar_link_hover_color')); ?>; }
	
	.navigation-menu{background-color:<?php echo harvest_hex_to_rgba(esc_attr(get_option('tmoption_top_menu_bg_color')),esc_attr(get_option('tmoption_top_menu_opacity'))); ?>}
	.mega-menu ul li a{color:#<?php echo esc_attr(get_option('tmoption_top_menu_text_color')); ?>; }
	.mega-menu ul li a:hover{color:#<?php echo esc_attr(get_option('tmoption_top_menu_texthover_color')); ?>; }
	...
	.site-header {
		...
		background-image: url("<?php echo esc_attr(get_option('tmoption_header_background_upload')); ?>");
		background-position:<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_header_back_position'))); ?>;
		background-repeat:<?php echo esc_attr(get_option('tmoption_header_back_repeat')); ?>;
		background-attachment:<?php echo esc_attr(get_option('tmoption_header_back_attachment')); ?>;
		<?php } ?>
	} 
	<?php 
	...
	body {	
		font-family: '<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_bodyfont_other'))); ?>', Arial, Helvetica, sans-serif;	
	}	
	<?php } } elseif(get_option('tmoption_bodyfont') != "" && get_option('tmoption_bodyfont') != "please-select"){ ?>
	body {	
		font-family: '<?php echo esc_attr(str_replace('+',' ',get_option('tmoption_bodyfont'))); ?>', Arial, Helvetica, sans-serif;	
	}
...
{
	background-color:#<?php echo esc_attr(get_option('tmoption_button_color')) ; ?>; 
}
...
.widget input[type="button"]:hover,.widget input[type="button"]:focus,.widget input[type="reset"]:hover,.widget input[type="reset"]:focus,.widget input[type="submit"]:hover,.widget input[type="submit"]:focus,a.button:hover,a.button:focus,button:hover,button:focus,.contributor-posts-link:hover,input[type="button"]:hover,input[type="button"]:focus,input[type="reset"]:hover,input[type="reset"]:focus,input[type="submit"]:hover,input[type="submit"]:focus,.calloutarea_button a.button:hover,.calloutarea_button a.button:focus,.button_content_inner a:hover,.button_content_inner a:focus,.woocommerce #content input.button:hover, .woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover, .woocommerce-page #content input.button:hover, .woocommerce-page #respond input#submit:hover, .woocommerce-page a.button:hover, .woocommerce-page button.button:hover, .woocommerce-page input.button:hover,.woocommerce #content input.button.disabled,.woocommerce #content input.button:disabled,.woocommerce #respond input#submit.disabled,.woocommerce #respond input#submit:disabled,.woocommerce a.button.disabled,.woocommerce a.button:disabled,.woocommerce button.button.disabled,.woocommerce button.button:disabled,.woocommerce input.button.disabled,.woocommerce input.button:disabled,.woocommerce-page #content input.button.disabled,.woocommerce-page #content input.button:disabled,.woocommerce-page #respond input#submit.disabled,.woocommerce-page #respond input#submit:disabled,.woocommerce-page a.button.disabled,.woocommerce-page a.button:disabled,.woocommerce-page button.button.disabled,.woocommerce-page button.button:disabled,.woocommerce-page input.button.disabled,.woocommerce-page input.button:disabled,.woocommerce #content table.cart .checkout-button:hover
	{
		background-color:#<?php echo esc_attr(get_option('tmoption_button_hover_color')) ; ?>; 
	}	
	<?php }  ?>		
</style>
...
function tm_panel_head(){
	...
	if ( $tm_bodyfont != '' || $tm_bodyfont_color != '') {
		if ( $tm_bodyfont != '' ) {
			...
			$body_style .= '<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family='.$tm_bodyfont_family.'" />';
	...
	if ( $tm_headerfont != '' || $tm_headerfont_color != '' ) {
		if ( $tm_headerfont != '' ) {
			...
			$header_style .= '<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family='.$tm_headerfont_family.'" />';
		...
		echo balanceTags($header_style);
	}
	//=========================================== Navigation Settings ===========================================//
	$tm_navfont_tag = '.mega-menu li a';
	...
	if ( $tm_navfont != '' || $tm_navfont_color != '') {
		if ( $tm_navfont != '' ) {
			...
			$nav_style .= '<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family='.$tm_navfont_family.'" />';
	...
	$tm_footercolor_tag = '.site-footer a';
	...
	if ($tm_footercolor != '') {
		...
		echo balanceTags($footer_style);
	}	
}
add_action('tm_show_panel','tm_control_panel',15);
        ...
        <form method="post" id="panel_form" name="panel_form">
          ...
          <div class="tm-panel-block">
            <div class="tm-panel-title">
              <?php esc_html_e('Header font','harvest');?>
            </div>
            <?php 
          ...
          <div class="tm-panel-block">
            <div class="tm-panel-title">
              <?php esc_html_e('Link Color','harvest');?>
            </div>
            <?php
          ...
          <div class="tm-panel-block">
            <div class="tm-panel-title-back">
              <?php esc_html_e('Footer Link Color','harvest');?>
            </div>
            <?php
						$footercolor = (isset($_COOKIE['tm_footercolor'])) ? $_COOKIE['tm_footercolor'] : (get_option('tmoption_footerlink_color'));
						if($footercolor == ''){$footercolor_style='style="background-color:#FFFFFF"';}else{$footercolor_style = ($footercolor != (get_option('tmoption_footerlink_color'))) ? 'style="background-color:#'.$footercolor.'"' : 'style="background-color:#'.(get_option('tmoption_footerlink_color')).'"';}
						?>
            <div class="tm-panel-colorpicker">
          ...
          <div class="more-set"> <a style="color:#000; font-size:12px;" href="<?php echo esc_url(admin_url()); ?>admin.php?page=tm_theme_settings" target="_blank">
            <?php esc_html_e('See more settings in admin panel','harvest');?>
            </a> </div>
          <!--more-set-->
        </form>
        <!--panel_form-->
