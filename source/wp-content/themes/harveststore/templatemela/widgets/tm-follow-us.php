...
<div id="follow_us" class="follow-us">	
	...
	<?php if(!empty($linkURL1)) :  ?>
		<a href="<?php echo esc_url($linkURL1); ?>" title="<?php echo esc_html__('Facebook', 'harvest');?>" class="facebook icon"><i class="fa fa-facebook"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL2)) :  ?>
		<a href="<?php echo esc_url($linkURL2); ?>" title="<?php echo esc_html__('Twitter', 'harvest');?>" class="twitter icon"><i class="fa fa-twitter"></i></a>
	<?php endif; ?>	
	<?php if(!empty($linkURL3)) :  ?>
		<a href="<?php echo esc_url($linkURL3); ?>" title="<?php echo esc_html__('Linkedin', 'harvest');?>" class="linkedin icon"><i class="fa fa-linkedin"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL4)) :  ?>
		<a href="<?php echo esc_url($linkURL4); ?>" title="<?php echo esc_html__('RSS', 'harvest');?>" class="rss icon"><i class="fa fa-rss"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL5)) :  ?>
		<a href="<?php echo esc_url($linkURL5); ?>" title="<?php echo esc_html__('Youtube', 'harvest');?>" class="youtube icon"><i class="fa fa-youtube"></i></a>
	<?php endif; ?>	
	<?php if(!empty($linkURL6)) :  ?>
		<a href="<?php echo esc_url($linkURL6); ?>" title="<?php echo esc_html__('Pinterest', 'harvest');?>" class="pinterest icon"><i class="fa fa-pinterest"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL7)) :  ?>
		<a href="<?php echo esc_url($linkURL7); ?>" title="<?php echo esc_html__('Google Plus', 'harvest');?> " class="google-plus icon"><i class="fa fa-google-plus"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL8)) :  ?>
		<a href="<?php echo esc_url($linkURL8); ?>" title="<?php echo esc_html__('Skype', 'harvest');?>" class="skype icon"><i class="fa fa-skype"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL9)) :  ?>
		<a href="<?php echo esc_url($linkURL9); ?>" title="<?php echo esc_html__('Instagram', 'harvest');?>" class="instagram icon"><i class="fa fa-instagram"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL10)) :  ?>
		<a href="<?php echo esc_url($linkURL10); ?>" title="<?php echo esc_html__('Whatsapp', 'harvest');?>" class="whatsapp icon"><i class="fa fa-whatsapp"></i></a>
	<?php endif; ?>
</div>
<?php
...
<div>&nbsp;</div>
<p>
  <label for="<?php echo esc_attr($this->get_field_id('linkURL10'));?>"><strong>Whatsapp</strong></label>
<p>
  ...
  <label>(e.g. http://www.whatsapp.com/...)</label>
  <br />
</p>
<?php
	}
